import { r as reactExports, U as React, a2 as notFound, V as jsxRuntimeExports } from "./server-InY6yCPf.js";
import { c as createLucideIcon, M as clsx, N as Route, o as useCatalog, w as useWishlist, t as toast, L as Link, m as motion, r as Sparkles, B as Button, O as updateDoc, Q as doc, T as db } from "./router-B763mWGC.js";
import { J as analyzeListingRisk, N as Navbar, L as ListingSafetyBanner, H as Heart, B as BadgeCheck, M as MapPin, D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter, P as ProductCard } from "./navbar-D1XcfPQY.js";
import { F as Footer } from "./footer-Dmm9X49a.js";
import { b as useTransferCoins } from "./economy-B76-Rikm.js";
import { A as ArrowLeft } from "./arrow-left-z1cYGNxi.js";
import { T as TrendingUp } from "./trending-up-D-1yCYV9.js";
import { c as commonjsGlobal, g as getDefaultExportFromCjs } from "./worker-entry-DE8uvRpa.js";
...
function ProductDetails() {
  ...
  const [returnStatus, setReturnStatus] = reactExports.useState("Active Rental");
  ...
  const avgRating = reactExports.useMemo(() => {
    const sum = reviews.reduce((a2, r) => a2 + r.rating, 0);
  ...
  reactExports.useEffect(() => {
    ...
    toast.warning("Listing flagged — review carefully", {
      description: "Automated checks found elevated risk signals. Read the safety notice and verify before paying."
    });
  }, [product]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/marketplace", className: "mb-6 inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
            ...
            duration: 0.25
          }, className: "overflow-hidden rounded-3xl border border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: gallery[active], alt: product.title, className: "aspect-square w-full object-cover" }) }, active),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 grid grid-cols-4 gap-3", children: gallery.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActive(i), className: `overflow-hidden rounded-xl border-2 transition ${active === i ? "border-primary" : "border-transparent opacity-70 hover:opacity-100"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: g, alt: "", className: "aspect-square w-full object-cover" }) }, i)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5 text-[11px] font-medium text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-secondary px-2 py-0.5", children: product.category }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-secondary px-2 py-0.5", children: product.condition }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "rounded-full bg-secondary px-2 py-0.5", children: [
              "Posted ",
              product.postedAgo
            ] }),
            product.usedFor ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "rounded-full bg-secondary px-2 py-0.5", children: [
              "Used for ",
              product.usedFor
            ] }) : null,
            product.availability ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-secondary px-2 py-0.5", children: product.availability }) : null
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 font-display text-3xl font-semibold italic leading-tight tracking-tight sm:text-4xl", children: product.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex items-end gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-4xl font-bold tracking-tight", children: [
              "₹",
              product.price.toLocaleString("en-IN")
            ] }),
            product.originalPrice && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pb-1 text-base text-muted-foreground line-through", children: [
              "₹",
              product.originalPrice.toLocaleString("en-IN")
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-sm leading-relaxed text-muted-foreground", children: product.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListingSafetyBanner, { product }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid gap-3 sm:grid-cols-2", children: [{
            k: "Pickup",
            v: product.pickupLocation ?? "On campus"
          }, {
            k: "Department",
            v: product.department ?? "—"
          }, {
            k: "Price",
            v: typeof product.negotiable === "boolean" ? product.negotiable ? "Negotiable" : "Fixed" : "—"
          }, {
            k: "Age",
            v: product.itemAge ?? "—"
          }].map((x2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-4 shadow-soft", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] font-semibold uppercase tracking-wider text-muted-foreground", children: x2.k }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm font-semibold", children: x2.v })
          ] }, x2.k)) }),
          product.tags?.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap gap-2", children: product.tags.slice(0, 8).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full border border-border bg-secondary/50 px-3 py-1 text-[11px] font-medium text-muted-foreground", children: t }, t)) }) : null,
          product.specs?.length ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-2xl border border-border bg-card p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: "Specifications" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 space-y-2 text-sm text-muted-foreground", children: product.specs.slice(0, 8).map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 h-1.5 w-1.5 rounded-full bg-muted-foreground/50" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: s2 })
            ] }, s2)) })
          ] }) : null,
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-card to-secondary/40 p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: "AI fair-price estimate" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Based on 142 similar campus listings" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-success/15 px-2.5 py-1 text-[11px] font-semibold text-success", children: "94% confidence" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid gap-4 sm:grid-cols-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Estimated value" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Demand" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex items-center gap-1 text-sm font-semibold text-success", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-3.5 w-3.5" }),
                  " High"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Condition impact" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm font-semibold", children: "+8% premium" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 h-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: trend, margin: {
              left: 0,
              right: 0,
              top: 6,
              bottom: 0
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "m", hide: true }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { hide: true, domain: ["auto", "auto"] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
                background: "var(--card)",
                border: "1px solid var(--border)",
                borderRadius: 12,
                fontSize: 12
              }, formatter: (v) => [`₹${v.toLocaleString("en-IN")}`, "Avg"] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "p", stroke: "var(--primary)", strokeWidth: 2, fill: "url(#g)" })
            ] }) }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", className: "flex-1 rounded-full bg-brand-gradient text-primary-foreground shadow-elegant hover:opacity-90", onClick: handleBuyWithCoins, disabled: transferring || product.availability === "Sold" || product.availability === "Rented", children: transferring ? "Processing..." : `Buy now · ₹${product.price.toLocaleString("en-IN")}` }),
            product.forRent && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", variant: "outline", className: "rounded-full", onClick: handleRentWithCoins, disabled: transferring || product.availability === "Sold" || product.availability === "Rented", children: [
              "Rent · ₹",
              product.rentPerDay,
              "/day"
            ] }),
            product.forRent ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", variant: "outline", className: "rounded-full", onClick: () => setReturnOpen(true), "aria-label": "Return item", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, {}) }) : null,
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", variant: "outline", className: "rounded-full", onClick: () => wishlist.toggle(product), "aria-label": "Wishlist", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: liked ? "fill-foreground text-foreground" : "" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", variant: "outline", className: "rounded-full", "aria-label": "Share", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, {}) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-2xl border border-border bg-card p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: product.seller.avatar, alt: "", className: "h-12 w-12 rounded-full" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  product.sellerId ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/profile/$userId", params: {
                    userId: product.sellerId
                  }, className: "font-semibold hover:underline", children: product.seller.name }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: product.seller.name }),
                  product.seller.verified && /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeCheck, { className: "h-4 w-4 text-foreground" })
                ] }),
              ...
              product.sellerId ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/chat", search: {
                peerUid: product.sellerId,
                peerName: product.seller.name,
                peerAvatar: product.seller.avatar
              }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "rounded-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-4 w-4" }),
                " Chat"
              ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/chat", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "rounded-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-4 w-4" }),
                " Messages"
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid grid-cols-2 gap-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-xl bg-secondary/60 p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-4 w-4 text-foreground" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Verified college email" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-xl bg-secondary/60 p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4 text-foreground" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Member since 2024" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-2xl border border-border bg-card p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold italic", children: "Seller reviews" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex items-center gap-2 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5 text-foreground/80", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: `h-3.5 w-3.5 ${i < Math.round(avgRating) ? "fill-current" : ""}` }, i)) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: avgRating.toFixed(1) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "rounded-full", onClick: () => setReviewOpen(true), children: "Write review" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 space-y-3", children: reviews.slice(0, 3).map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-secondary/20 p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: r.name }),
                    r.verified ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-success/15 px-2 py-0.5 text-[11px] font-semibold text-success", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeCheck, { className: "h-3.5 w-3.5" }),
                      " Verified buyer"
                    ] }) : null
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 flex items-center gap-0.5 text-foreground/80", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: `h-3.5 w-3.5 ${i < r.rating ? "fill-current" : ""}` }, i)) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground", children: r.time })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: r.text })
            ] }, r.id)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 rounded-2xl border border-dashed border-border bg-card p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: "Suggested meet-up" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: "Both of you study near the Central Library. Tap below to coordinate a safe spot." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: ["Central Library", "Cafeteria Block C", "Main Gate"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded-full border border-border bg-secondary/60 px-3 py-1 text-xs hover:bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: reviewOpen, onOpenChange: setReviewOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Write a review" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Share quick feedback for the seller after your transaction." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-muted-foreground", children: "Rating" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex items-center gap-1", children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setReviewRating(n), className: "rounded-lg p-1.5 transition hover:bg-secondary", "aria-label": `Rate ${n} stars`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: `h-5 w-5 ${n <= reviewRating ? "fill-current text-foreground" : "text-muted-foreground"}` }) }, n)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-muted-foreground", children: "Review" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: reviewText, onChange: (e) => setReviewText(e.target.value), placeholder: "e.g. Smooth transaction and genuine pricing.", className: "min-h-28 w-full resize-none rounded-xl border border-border bg-background px-3 py-2 text-sm outline-none focus:border-primary" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "rounded-full", onClick: () => setReviewOpen(false), children: "Cancel" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: returnOpen, onOpenChange: setReturnOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Return rental" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Request a return for this rented listing and coordinate hand-off details." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between rounded-2xl border border-border bg-card p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: "Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: returnStatus === "Returned Successfully" ? "rounded-full bg-success/15 px-2.5 py-1 text-[11px] font-semibold text-success" : returnStatus === "Return Requested" ? "rounded-full bg-warning/15 px-2.5 py-1 text-[11px] font-semibold text-warning" : "rounded-full bg-primary/10 px-2.5 py-1 text-[11px] font-semibold text-primary", children: returnStatus })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-muted-foreground", children: "Preferred return date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "date", value: returnDate, onChange: (e) => setReturnDate(e.target.value), className: "w-full rounded-xl border border-border bg-background px-3 py-2 text-sm outline-none focus:border-primary", disabled: returnStatus !== "Active Rental" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "rounded-full", onClick: () => setReturnOpen(false), children: "Close" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "rounded-full bg-brand-gradient text-primary-foreground shadow-soft hover:opacity-90", disabled: !product.forRent || returnStatus !== "Active Rental", onClick: () => setReturnStatus("Return Requested"), children: "Confirm return request" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-semibold italic tracking-tight", children: "Similar listings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid grid-cols-2 gap-4 md:grid-cols-4", children: similar.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product: p, index: i }, p.id)) })
      ] })
    ] }) }),
