...
import { g as getDefaultExportFromCjs } from "./worker-entry-DE8uvRpa.js";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DxTKGtVa.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B763mWGC.js").then((n2) => n2.ae),
    import("./start-6VFg7mN_.js"),
