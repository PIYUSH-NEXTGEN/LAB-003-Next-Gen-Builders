...
import { u as useWalletBalance, a as useTransactionHistory, W as Wallet, C as Clock } from "./economy-B76-Rikm.js";
import { c as createLucideIcon, a as cn, u as useAuth } from "./router-B763mWGC.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-1 border-none bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl font-black tracking-tighter", children: loadingBalance ? "..." : `₹${balance?.toLocaleString("en-IN")}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-amber-100/80", children: "Use your wallet to buy and rent items on the marketplace." })
        ] })
      ] }),
